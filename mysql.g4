...
create_table_column: (' ')* columnName (' ')* columnType;
...
type: INT_TYPE | FLOAT_TYPE | STRING_TYPE | DOUBLE_TYPE | VARCHAR_TYPE | DECIMAL_TYPE | IDENTIFIER ;

//constants :constant (COMMA constant)*;

operation:EQUALS | GT | GE| LT| LE | NE |diana;
